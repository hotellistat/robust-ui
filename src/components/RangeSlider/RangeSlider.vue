<template>
  <div ref="slider" class="base-slider relative" role="slider"
    ...
    <input v-if="name" class="base-slider__hidden-input" type="hidden" :name="name" :value="value" />

    <div ref="track" class="base-slider__track w-full relative" @mousedown="onDragStart"
