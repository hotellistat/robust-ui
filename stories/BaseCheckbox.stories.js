...
const DefaultTemplate = (args) => ({
  template: '<base-checkbox v-bind="computedArgs" v-model="args.modelValue"></base-checkbox>',
...
const SlotTemplate = (args) => ({
  template: '<base-checkbox v-bind="argsWithoutTitle"><template v-slot:title>{{args.title}}</template></base-checkbox>',
  components: { BaseCheckbox },
  setup () {
