import{_ as f}from"./index-af6d963e.js";import"./vue.esm-bundler-b2033fd2.js";import"./index-693acf9b.js";import"./PhWarningCircle.vue-7ee36e3e.js";const w={title:"Ui/Input",component:f,argTypes:{readonly:{control:{type:"boolean"}},condensed:{control:{type:"boolean"}},modelValue:{control:{type:"text"}},outline:{control:{type:"boolean"}},hint:{control:{type:"text"}},error:{control:{type:"text"}}}},r=(x,{events:v})=>({template:`<Input class="mb-4" :cthulu="true" @="events" v-bind="args">
    <template #prefix>
    test
    </template>
    <template #suffix>
