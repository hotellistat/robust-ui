import{_ as f}from"./index-aabe200f.js";import"./vue.esm-bundler-b4bdeeb0.js";import"./index-fb9fd3fa.js";import"./PhWarningCircle.vue-6d2e90a0.js";const w={title:"Ui/Input",component:f,argTypes:{readonly:{control:{type:"boolean"}},condensed:{control:{type:"boolean"}},modelValue:{control:{type:"text"}},outline:{control:{type:"boolean"}},hint:{control:{type:"text"}},error:{control:{type:"text"}}}},r=(x,{events:v})=>({template:`<Input class="mb-4" :cthulu="true" @="events" v-bind="args">
    <template #prefix>
    test
    </template>
    <template #suffix>
...
//# sourceMappingURL=index.stories-4bb2c60e.js.map
