import{_ as a}from"./index-7e9830df.js";import{j as p}from"./vue.esm-bundler-3b691b43.js";import"./PhCheck.vue-16f6c1e2.js";const h={title:"Ui/Checkbox",component:a,argTypes:{title:{control:{type:"text"}}}},i=o=>({template:'<Checkbox v-bind="args" v-model="value"></Checkbox>{{value}}',components:{Checkbox:a},setup(){return{value:p(!1),args:o}}}),e=i.bind({});e.args={title:"Checkbox title"};const v=o=>({template:'<Checkbox v-model="value"><template v-slot:title>{{args.title}}</template></Checkbox>',components:{Checkbox:a},setup(){return{value:p(!1),args:o}}}),t=v.bind({});t.args={title:"V-Slot Checkbox title"};var s,n,l;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`args => ({
...
//# sourceMappingURL=index.stories-87bfd294.js.map
