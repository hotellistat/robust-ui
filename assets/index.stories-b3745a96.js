import{j as i}from"./vue.esm-bundler-b37ea11a.js";import{_ as o}from"./index-533ae1c1.js";const d={title:"Ui/FLoating",component:o,argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}}}},l=r=>({template:'<FLoating v-bind="args" v-model="value">ldsajfk</FLoating>',components:{FLoating:o},setup(){const s=i(!1);return{args:r,value:s}}}),t=l.bind({});t.args={title:"FLoating title",description:"FLoating description text to be placed here"};var e,n,a;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`args => ({
...
//# sourceMappingURL=index.stories-b3745a96.js.map
