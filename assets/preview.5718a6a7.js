import{w as M}from"./window.1c13f9df.js";import{d as v}from"./index.67736049.js";import"./_commonjsHelpers.b8add541.js";var p="backgrounds",{document:s,window:k}=M,B=()=>k.matchMedia("(prefers-reduced-motion: reduce)").matches,S=(r,e=[],d)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===d);if(t)return t.value;if(d){let a=e.map(i=>i.name).join(", ");__STORYBOOK_MODULE_CLIENT_LOGGER__.logger.warn(v`
...
//# sourceMappingURL=preview.5718a6a7.js.map
