import{_ as f}from"./index-f9c8087d.js";import"./vue.esm-bundler-ebcf9369.js";import"./index-44e83eb1.js";import"./PhWarningCircle.vue-346e7bab.js";const w={title:"Ui/Input",component:f,argTypes:{readonly:{control:{type:"boolean"}},condensed:{control:{type:"boolean"}},modelValue:{control:{type:"text"}},outline:{control:{type:"boolean"}},hint:{control:{type:"text"}},error:{control:{type:"text"}}}},r=(x,{events:v})=>({template:`<Input class="mb-4" :cthulu="true" @="events" v-bind="args">
    <template #prefix>
    test
    </template>
    <template #suffix>
...
//# sourceMappingURL=index.stories-f3bd0e1b.js.map
