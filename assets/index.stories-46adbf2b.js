import{j as c}from"./vue.esm-bundler-9cbc270d.js";import{_ as s}from"./index-1469d29d.js";const m={title:"Ui/Switch",component:s,argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}}}},i=o=>({template:'<Switch v-bind="args" v-model="value"></Switch>',components:{Switch:s},setup(){const a=c(!1);return{args:o,value:a}}}),t=i.bind({});t.args={title:"Switch title",description:"Switch description text to be placed here"};var e,r,n;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`args => ({
...
//# sourceMappingURL=index.stories-46adbf2b.js.map
