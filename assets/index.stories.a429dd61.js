import{_ as e}from"./index.46b0f031.js";import{d as n,Z as o}from"./vue-phosphor-icons.eb343088.js";import"./iframe.d0acd4d4.js";import"./index.925cb22a.js";import"./_plugin-vue_export-helper.cdc0426e.js";const m={title:"Ui/Button",component:e,argTypes:{onClick:{action:"clicked"},variant:{control:{type:"select",options:["primary","warn","muted","transparent","danger","danger-text","danger-outline"]}},loading:{control:{type:"boolean"}},disabled:{control:{type:"boolean"}},condensed:{control:{type:"boolean"}},rounded:{control:{type:"boolean"}}}},a=t=>({components:{Button:e},template:'<Button v-bind="args" >Click here</Button>',setup(){return{args:t}}}),f=a.bind({}),r=t=>({template:`<Button v-bind="args">
...
//# sourceMappingURL=index.stories.a429dd61.js.map
