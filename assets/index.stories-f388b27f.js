import{_ as f}from"./index-59e1a890.js";import"./vue.esm-bundler-17561e39.js";import"./index-70d4b3d5.js";import"./PhWarningCircle.vue-fc65e2d4.js";const w={title:"Ui/Input",component:f,argTypes:{readonly:{control:{type:"boolean"}},condensed:{control:{type:"boolean"}},modelValue:{control:{type:"text"}},outline:{control:{type:"boolean"}},hint:{control:{type:"text"}},error:{control:{type:"text"}}}},r=(x,{events:v})=>({template:`<Input class="mb-4" :cthulu="true" @="events" v-bind="args">
    <template #prefix>
    test
    </template>
    <template #suffix>
...
//# sourceMappingURL=index.stories-f388b27f.js.map
