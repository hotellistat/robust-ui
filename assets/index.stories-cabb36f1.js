import{_ as a}from"./index-1ecb7cde.js";import{r as m}from"./vue.esm-bundler-3bce978e.js";import"./PhCheck.vue-ef873fb8.js";const h={title:"Ui/Checkbox",component:a,argTypes:{title:{control:{type:"text"}},description:{control:{type:"text"}}}},i=o=>({template:'<Checkbox v-bind="args" v-model="value"></Checkbox>',components:{Checkbox:a},setup(){return{value:m(!1),args:o}}}),e=i.bind({});e.args={title:"Checkbox title"};const d=o=>({template:'<Checkbox v-model="value"><template v-slot:title>{{args.title}}</template></Checkbox>',components:{Checkbox:a},setup(){return{value:m(!1),args:o}}}),t=d.bind({});t.args={title:"V-Slot Checkbox title"};var s,n,r;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`args => ({
